...
def run_test_draw_points_on_circle():
    ...
    draw_points_on_circle(window, circle, 88, 'purple')
    window.close_on_mouse_click()
...
def run_test_pizza():
    ...
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 3
    pizza(window, circle, 5, 'yellow', 1)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    #Test 3:
    title = 'POLYGON test 3: 4 segments with thick green lines'
    window = rg.RoseWindow(550, 400, title)
    circle = rg.Circle(rg.Point(100, 100), 80)
    circle.outline_thickness = 3
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    another_line = rg.Line(points[number_of_segments-1], points[0])
    another_line.attach_to(window)
    another_line.thickness = thickness
    another_line.color = color
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  20 blue lines on green circle, hops = 5.'
    window = rg.RoseWindow(480, 350, title)
